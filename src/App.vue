<template>
  <div id="app">
    <!-- <div id="nav">
      ...
      <router-link to="/about">About badgers</router-link>
    </div>
    <router-view/> -->
                ...
                <div class="ibox ">
                    <div class="ibox-content text-center p-md">
                        ...
                        <div class="m-t-md">
                            ...
                            <div class="p-lg ">
                                <a href="full_height.html"><img class="img-fluid img-shadow" src="img/full_height.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ibox ">
                    <div class="ibox-content text-center p-md">
                        ...
                        <div class="m-t-md">
                            ...
                            <div class="p-lg">
                                <a href="off_canvas_menu.html"><img class="img-fluid img-shadow" src="img/off_canvas.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<style scoped src="@/assets/font-awesome/css/font-awesome.css">
</style>
